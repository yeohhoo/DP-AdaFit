...
def main():
    ...
    # # save the statistics results to .npz file for 
    # ref_out_path = os.path.join(logger.get_dir(), f"ref_batch.npz")
    # print(f"saving to {ref_out_path}")
    # data_ref = np.load(args.ref_batch)
    # if "arr_1" in data_ref.files:
    #     np.savez(ref_out_path, 
    #              mu = ref_stats.mu,
    #              sigma = ref_stats.sigma,
    #              mu_s = ref_stats_spatial.mu,
    #              sigma_s = ref_stats_spatial.sigma,
    #              arr_0 = data_ref['arr_0'],
    #              arr_1 = data_ref['arr_1'])
    # else:
    #     np.savez(ref_out_path, 
    #              mu = ref_stats.mu,
    #              sigma = ref_stats.sigma,
