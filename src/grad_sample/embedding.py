...
def compute_embedding_grad_sample_with_aug(
    layer: nn.Embedding, activations: torch.Tensor, backprops: torch.Tensor, K: int
...
def compute_embeddingbag_gradsampler_with_aug(layer, inputs, backprops, K):
    index, offset = inputs
