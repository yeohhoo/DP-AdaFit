...
def ft_compute_per_sample_gradient(layer, activations, backprops, K=0):
    """
    ...
    Args:
        ...
        K: whether or not apply augmentation multiplier, default K = 0
    """
    ...
    )  # per_sample_grads is the list of[weight_grad_tensor, bias_grad_tensor]

    if K:
        ft_per_sample_grads_by_k = []
        for ft_per_sample_grad in per_sample_grads:
        ...
        per_sample_grads = ft_per_sample_grads_by_k
